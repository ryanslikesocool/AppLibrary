...
@main
public struct AppLibraryDockHelperClient: AppLibraryXPCClientProtocol {
	public static var xpcServiceName: XPCServiceName { .dockHelper }
	...
	func performTask(with request: DockHelperMessage.Request) -> (any Encodable)? {
		do {
...
private extension AppLibraryDockHelperClient {
